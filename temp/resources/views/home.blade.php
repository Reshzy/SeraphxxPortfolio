...
<div class="py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg shadow-xl p-8 mb-8 text-white">
            ...
            <a href="/portfolio" class="btn btn-primary bg-white text-purple-700 hover:bg-gray-100">View My Work</a>
        </div>
        ...
        <section id="about" class="mb-12">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="text-center mt-4">
                    <a href="/about" class="text-purple-700 hover:text-purple-900 font-medium">Learn more about me →</a>
                </div>
            </div>
        </section>
        ...
        <section class="mb-12">
            ...
            <div class="text-center mt-6">
                <a href="/commissions" class="text-purple-700 hover:text-purple-900 font-medium">View all commission options →</a>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="text-center mt-6">
                <a href="/portfolio" class="text-purple-700 hover:text-purple-900 font-medium">View my full portfolio →</a>
            </div>
        </section>
    </div>
</div>
